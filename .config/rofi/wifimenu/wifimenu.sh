...
#source "/home/adrian/.config/rofi/wifimenu/wifimenu1.rasi"

config /home/adrian/.config/rofi/wifimenu/wifimenu1.rasi


#if [ -r "$DIR/config" ]; then
#	source "$DIR/config"
#elif [ -r "$HOME/.config/rofi/wifimenu/wifimenu.rasi" ]; then
#	source "$HOME/.config/rofi/wifimenu/wifimenu.rasi"
#else
